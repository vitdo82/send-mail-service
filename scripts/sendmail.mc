divert(-1)dnl
#-----------------------------------------------------------------------------
# $Sendmail: debproto.mc,v 8.18.1 2024-08-04 18:25:02 debian Exp $
#
...
VERSIONID(`$Id: sendmail.mc,v 8.18.1-6 2024-08-04 18:25:02 debian Exp $')
OSTYPE(`debian')dnl
...
DAEMON_OPTIONS(`Family=inet, Name=MTA, Port=smtp, Addr=0.0.0.0')dnl
...
define(`confDOMAIN_NAME', `smtp.vitdo.com')dnl
dnl #
dnl # Features
dnl #
